          ...
          <h1 className={` custom-animation ${searchComp && "active"} font-primaryHeading relative before:content-[''] before:absolute before:-bottom-2 before:left-1/2 before:transform before:-translate-x-2/4 before:w-11/12 max-w-16rem before:h-1 before:bg-background-secondary-accent-color before:rounded-full text-base leading-5 text-center mb-8  normal:text-lg normal:before:w-full sm:text-2xl sm:before:h-2 sm:before:-bottom-4 sm:before:left-60 sm:mb-0 sm:max-w-128`}>Project, that I've worked on -</h1>
            ...
            <div className="projects  w-8/12 mx-auto mt-4 tiny:mt-8 normal:mt-10 fit:mt-14 md:mt-20  pb-8 tiny:w-full  tiny:px-4 fit:px-6 sm:px-8 lg:max-w-76rem" >
                <div onMouseEnter={() => {
                    ...
                    <div className={` ${card1 ? "projects-overlay": "hide-project-overlay"} absolute top-0 left-0 bottom-0 right-0   flex flex-col justify-between`}>
                ...
                <div onMouseEnter={() => {
                    ...
                    <div className={` ${card2 ? "projects-overlay": "hide-project-overlay"} absolute top-0 left-0 bottom-0 right-0   flex flex-col justify-between`}>
                ...
                <div onMouseEnter={() => {
                    ...
                    <div className={` ${card3 ? "projects-overlay": "hide-project-overlay"} absolute top-0 left-0 bottom-0 right-0   flex flex-col justify-between`}>
                ...
                <div onMouseEnter={() => {
                    ...
                    <div className={` ${card4 ? "projects-overlay": "hide-project-overlay"} absolute top-0 left-0 bottom-0 right-0   flex flex-col justify-between`}>
                ...
                <div onMouseEnter={() => {
                    ...
                    <div className={` ${card5 ? "projects-overlay": "hide-project-overlay"} absolute top-0 left-0 bottom-0 right-0   flex flex-col justify-between`}>
                ...
                <div onMouseEnter={() => {
                    ...
                    <div className={` ${card6 ? "projects-overlay": "hide-project-overlay"} absolute top-0 left-0 bottom-0 right-0   flex flex-col justify-between`}>
