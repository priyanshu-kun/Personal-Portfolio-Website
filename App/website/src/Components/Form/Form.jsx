            ...
            <div className="form w-11/12  mx-auto flex items-center justify-center max-w-128">
                {
                  !isSubmitted ? (
                      ...
                      <form onSubmit={handleSubmitForm} action="#" className="flex flex-col w-full">
                          ...
                          <div className= "flex flex-col" >
                              <div className="relative mb-2 input-wrap-1">
                                ...
                                <label className="text-txt-primary-dark-bg font-primaryHeading absolute left-2 top-2 text-tiny tracking-widest peer-placeholder-shown:text-tiny peer-placeholder-shown:text-txt-primary-dark-bg peer-placeholder-shown:top-6 transition-all peer-placeholder-shown:left-6 peer-focus:top-2 peer-focus:left-2 peer-focus:text-super-tiny peer-focus:text-txt-primary-dark-bg normal:peer-placeholder-shown:text-base normal:peer-placeholder-shown:top-5.5 normal:peer-focus:text-tiny normal:peer-focus:top-2 tempScreen:peer-placeholder-shown:top-6 tempScreen:peer-focus:top-2 sm:peer-placeholder-shown:top-6.5 sm:peer-focus:top-1 md:peer-placeholder-shown:left-8 md:peer-focus:left-2" htmlFor="name" >YOUR GOOD नाम (NAME)</label>
                              </div>
                              <div className="relative mb-2 input-wrap">
                                ...
                                <label className="text-txt-primary-dark-bg font-primaryHeading absolute left-2 top-4 text-tiny tracking-widest peer-placeholder-shown:text-tiny peer-placeholder-shown:text-txt-primary-dark-bg peer-placeholder-shown:top-6 transition-all peer-placeholder-shown:left-6 peer-focus:top-4 peer-focus:left-2 peer-focus:text-super-tiny peer-focus:text-txt-primary-dark-bg normal:peer-placeholder-shown:text-base normal:peer-placeholder-shown:top-5.5 normal:peer-focus:text-tiny normal:peer-focus:top-4 tempScreen:peer-placeholder-shown:top-6 tempScreen:peer-focus:top-4 sm:peer-placeholder-shown:top-6.5 sm:peer-focus:top-3 md:peer-placeholder-shown:left-8 md:peer-focus:left-2" htmlFor="email" >YOUR EMAIL पता (ADDRESS)</label>
                              </div>
                              <div className="relative mb-2 input-wrap">
                              <textarea value={FormData.note} onChange={handleFormInputs} name="note" id="note" className="peer w-full text-tiny text-txt-primary-dark-bg normal:text-base sm:text-lg placeholder-transparent  mt-8 placeholder-shown:mt-0 focus-within:mt-8" cols="30" rows="10" placeholder="LEAVE A NOTE FOR ME"></textarea>
                                ...
                                <label className="text-txt-primary-dark-bg font-primaryHeading absolute left-2 top-4 text-tiny tracking-widest peer-placeholder-shown:text-tiny peer-placeholder-shown:text-txt-primary-dark-bg peer-placeholder-shown:top-6 transition-all peer-placeholder-shown:left-6 peer-focus:top-4 peer-focus:left-2 peer-focus:text-super-tiny peer-focus:text-txt-primary-dark-bg normal:peer-placeholder-shown:text-base normal:peer-placeholder-shown:top-5.5 normal:peer-focus:text-tiny normal:peer-focus:top-4 tempScreen:peer-placeholder-shown:top-6 tempScreen:peer-focus:top-4 sm:peer-placeholder-shown:top-6.5 sm:peer-focus:top-3 md:peer-placeholder-shown:left-8 md:peer-focus:left-2" htmlFor="note" >LEAVE A सन्देश (NOTE) FOR ME</label>
                              </div>
                    ...
                    <div className="flex flex-col items-center justify-center">
                        <div style={{width: "100%",height: "0", paddingBottom: "100%", position: "relative"}}><iframe src="https://giphy.com/embed/N4jpEIsgRb2yt1z2JO" width="100%" height="100%" style={{position: "absolute"}} frameBorder="0" className="giphy-embed" allowFullScreen></iframe></div><p><a className="text-super-tiny" href="https://giphy.com/gifs/churacosmy-thanks-chura-N4jpEIsgRb2yt1z2JO">Via Giphy</a></p>
