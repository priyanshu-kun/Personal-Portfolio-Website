      ...
      <nav className="nav">
           <div className="nav__content">
                    ...
                    <ul className="nav__list">
                        ...
                        <li className="nav__list-item leading-8 400:leading-12 md:leading-16 xl:leading-18"><a href="https://github.com/priyanshuSharma-WebDev" target="_blank" className="hover-target font-primaryHeading text-3xl 400:text-5xl  md:text-6xl xl:text-7xl">GITHUB</a></li>
