    ...
    return (
      <header className='header-section h-screen flex flex-col items-start justify-center sm:items-center xl:flex-row xl:relative'>
        ...
        <div className='w-auto flex flex-col sm:items-center'>
          ...
          <button aria-label='See my work' className='ml-8 action-btn mt-8 bg-background-primary-dark-color border border-solid border-txt-primary-dark-bg/10 text-txt-primary-dark-bg text-tiny h-12 w-40 400:h-14 400:w-44 400:text-base shadow-md rounded-lg  cursor-pointer sm:ml-0 md:h-16 md:w-52 md:text-lg' type='button'>
