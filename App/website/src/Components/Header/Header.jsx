    ...
    return (
      <header className='header-section h-screen flex flex-col items-start justify-center sm:items-center xl:flex-row xl:relative'>
        ...
        <div className='w-auto flex flex-col sm:items-center'>
          ...
          <button aria-label='See my work' className='ml-8 mt-8 action-btn text-txt-primary-dark-bg text-tiny h-12 w-40 400:h-14 400:w-44 400:text-base  rounded-md shadow-sm cursor-pointer sm:ml-0 md:h-16 md:w-52 md:text-lg' type='button'>
            <a href="#seeMyWork" className='w-full h-full flex items-center justify-center'>
                    See my Work
